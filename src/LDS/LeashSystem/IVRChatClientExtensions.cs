...
{
    public static void SendMovement(this IVRChatClient client, ref MovementData data) => client.SendMovement(data.VerticalOffset, data.HorizontalOffset, data.HorizontalLook, data.ShouldRun);
